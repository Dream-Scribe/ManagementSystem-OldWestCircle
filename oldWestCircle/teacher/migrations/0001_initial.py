...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Attend',
            fields=[
                ('activityid', models.OneToOneField(db_column='activityID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.activity')),
            ],
            options={
                'db_table': 'attend',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Coursereview',
            fields=[
                ('courseid', models.OneToOneField(db_column='courseID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.course')),
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('userid', models.OneToOneField(db_column='userID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.user')),
                ('registertime', models.DateTimeField(blank=True, db_column='registerTime', null=True)),
                ('nickname', models.CharField(blank=True, db_column='nickName', max_length=20, null=True)),
                ('realname', models.CharField(blank=True, db_column='realName', max_length=20, null=True)),
                ('phonenumber', models.CharField(db_column='phoneNumber', max_length=15)),
        ...
        migrations.CreateModel(
            name='Booking',
            fields=[
                ('studentid', models.OneToOneField(db_column='studentID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.student')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('userid', models.OneToOneField(db_column='userID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.student')),
        ...
        migrations.CreateModel(
            name='Teach',
            fields=[
                ('teacherid', models.OneToOneField(db_column='teacherID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='teacher.teacher')),
            ],
            options={
                'db_table': 'teach',
                'managed': False,
