...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('userid', models.OneToOneField(db_column='userID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='index.user')),
                ('registertime', models.DateTimeField(blank=True, db_column='registerTime', null=True)),
                ('nickname', models.CharField(blank=True, db_column='nickName', max_length=20, null=True)),
                ('realname', models.CharField(blank=True, db_column='realName', max_length=20, null=True)),
                ('phonenumber', models.CharField(db_column='phoneNumber', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('userid', models.OneToOneField(db_column='userID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='index.student')),
